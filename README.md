...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/objetos-inter2018/Adventures_Foreigner/settings). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
